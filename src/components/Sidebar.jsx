          ...
          >
            ...
            <div className="p-3 border-b border-white/10">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="h-8 w-8">
                  <button
                    ...
                    className="h-8 w-8 rounded-md hover:bg-gray-900/10 text-white/80 hover:text-white transition-colors flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-white/30"
                  >
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-2 rounded-md border border-white/15 text-white/90 hover:bg-gray-900/10 hover:border-white/25 transition-colors text-sm"
              >
                <span className="inline-flex items-center justify-center w-5 h-5 rounded-sm bg-gray-900 text-black">
                  <Plus size={14} />
                </span>
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm truncate transition-colors ${
                      activeSession === session.id
                        ...
                        : 'text-white/60 hover:text-white hover:bg-gray-900/5'
                    }`}
                  >
